          ...
          {SLOT_CONFIG.map(({ key, label }) => {
            ...
            return (
              ...
              >
                ...
                {player ? (
                  <>
                    {/* MOBILE COMPACT HORIZONTAL CARD LAYOUT (Screens < 768px: fits all 3 cards above fold) */}
                    <div className="md:hidden flex items-center gap-2.5 w-full my-0.5">
                      {/* Left: 8-bit player sprite (~55px width) on mini-pedestal */}
                      ...
                      {/* Center: Name, team/pos, game status, and stats */}
                      ...
                      {/* Right: Large vertical score readout (Bold LED style) */}
                    ...
                    {/* DESKTOP VERTICAL PODIUM LAYOUT (md: and above, STRICTLY PRESERVED) */}
                    <div className="hidden md:flex md:flex-1 md:flex-col md:items-center md:justify-between md:w-full">
                      ...
                      <div className="w-full text-center my-1 px-1">
                        ...
                        {/* Subtle Kickoff / Matchup Time directly beneath team/position */}
                        {gameSituation ? (
                  ...
                  <>
                    ...
                    {/* DESKTOP VERTICAL EMPTY SLOT (STRICTLY PRESERVED) */}
            ...
            <div className="w-full px-3 sm:px-5 py-2 sm:py-3 bg-[#064e3b] text-[#fae5b8] border-3 border-[#047857] shadow-[0_4px_0_0_#022c22] rounded-xs flex items-center justify-between gap-2 sm:gap-4 box-border">
              ...
              {onToggleLock && (
                <button
                  ...
                  className="touch-manipulation px-2.5 sm:px-4 py-1 sm:py-1.5 bg-transparent hover:bg-[#047857]/60 text-[#fae5b8]/80 hover:text-white font-pixel text-[10px] sm:text-xs border border-[#34d399]/40 hover:border-[#34d399] rounded-xs cursor-pointer transition-colors whitespace-nowrap shrink-0"
                  title="Unlock squad to make substitutions"
                >
                  <span className="md:hidden">✏️ Edit</span>
                  <span className="hidden md:inline">✏️ Edit Squad</span>
                </button>
              )}
            </div>
          ) : filledCount === 3 ? (
