  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 animate-in fade-in duration-150">
      ...
      <div className="flex items-center justify-center gap-3">
        <Activity size={32} className="text-[#38bdf8]" />
      ...
      <div className="pixel-box-cream p-4 sm:p-6 rounded-xs space-y-6">
        
        {/* Header Banner matching Leaderboard */}
        <div className="text-center pb-3 border-b-2 border-[#d4a86a]">
        ...
        <div>
          <div className="flex items-center justify-between pb-2 mb-3">
            ...
            <span className="font-retro text-[11px] text-[#784610] bg-[#fae9c8] px-2.5 py-0.5 border border-[#d4a86a] rounded-xs font-semibold">
              ESPN SYNC ACTIVE
            </span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between pb-2 mb-3 border-t-2 border-[#d4a86a] pt-4">
            <div className="flex items-center gap-2">
            ...
            <span className="font-retro text-[11px] text-[#784610] bg-[#fae9c8] px-2.5 py-0.5 border border-[#d4a86a] rounded-xs">
              HIGHEST FIRST
            </span>
          </div>
